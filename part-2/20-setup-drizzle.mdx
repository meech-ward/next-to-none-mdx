...
It should start running on [http://127.0.0.1:4983](http://127.0.0.1:4983). Visit that URL in your browser and make sure the three tables exist there. Feel free to add some data to the tables while you're there.
...
You can read the [Drizzle Queries](https://orm.drizzle.team/docs/rqb) docs to see more examples of queries.
