...
<InstructionBlock>
  <InstructionBlock.Action step={2}>
...
<InstructionBlock>
  <InstructionBlock.Action step={3}>
...
<InstructionBlock>
  <InstructionBlock.Action step={4}>
...
<InstructionBlock>
  <InstructionBlock.Action step={5}>
...
<SideBySide>
  ...
  - 📁 src
    - 📁 app 
      - 📁 post 
        - 📁 [id] (`/post/[id]` route) - 📁 [id] (`/post/[id]` route) - 📁 [id] (`/post/[id]` route)
          - 🔵 page.tsx (UI)
      ...
  ```
  ```post/[id]/page.tsx
