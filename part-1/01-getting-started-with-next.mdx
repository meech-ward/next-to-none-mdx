...
<SideBySide ratio="1:1" width="normal">
  ...
  <Card>
    <FileTree focus={[{depth:1, item:2}, {depth:2, item:1}, {depth:3, item:1}, {depth:3, item:2}, {depth:3, item:3}]}>
    - public
    - src
      - app
        - page.tsx
...
<SideBySide ratio="2:3" width="normal">
  <ExampleCard>
...
We have now defined a new route that maps to the url: [`localhost:3000/create-post`](http://localhost:3000/create-post)
...
Now you can visit [`localhost:3000/create-post`](http://localhost:3000/create-post) to see the new page.
...
<SideBySide ratio="3:5" width="normal">
<Card>
